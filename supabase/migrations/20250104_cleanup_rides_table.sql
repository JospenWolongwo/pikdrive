-- Cleanup rides table - Remove unwanted fields
...
-- Add comments to clarify the purpose of remaining fields
COMMENT ON COLUMN public.rides.seats_available IS 'Number of available seats for this ride';
COMMENT ON COLUMN public.rides.car_model IS 'Model of the drivers car';
COMMENT ON COLUMN public.rides.car_color IS 'Color of the drivers car'; 