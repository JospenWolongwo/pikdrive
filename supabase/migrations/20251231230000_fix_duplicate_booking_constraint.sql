-- Fix duplicate booking constraint issue
-- When a user tries to create a booking after cancelling a previous one,
-- we should update the cancelled booking instead of failing on unique constraint
