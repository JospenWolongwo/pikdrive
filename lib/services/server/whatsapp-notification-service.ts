...
export class ServerWhatsAppNotificationService {
  ...
  validateTemplateVariables(templateName: string, variables: readonly string[]): void {
    ...
    const templateVariableCounts: Record<string, number> = {
      ...
      booking_confirmation_v4: 9, // same variables as v2/v3; Meta-approved booking confirmation template
      booking_confirmation_v5: 10, // v4 + destination dropoff_point_name
      ...
      ride_cancelled_by_driver_v1: 5, // user_name, route, refund_amount, refund_status, support_link
